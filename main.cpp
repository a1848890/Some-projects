...
int main(){
    /*define store*/
    Store my_store(STORE_CAPACITY);  // Create a store with capacity of 60, see the hash define
    my_store.print_menu();   // printout the functional menu
    ...
    /**/ 
            ...
            while(std::cin.fail()) { // to ingnore all the invalid input and ask for a valid input 
                cout << "Please enter an integer for the price\n" << std::endl;
                cin.clear();
                cin.ignore(256,'\n');
                cin >> temp_input_price;
            }
            ...
            my_store.print_menu(); // print the menu
        ...
        /*Add Vehicles*/
            ...
            cin >> temp_ID;
            while(std::cin.fail()) { // to ingnore all the invalid input and ask for a valid input
                cout << "Please enter an integer for the vehicle ID\n" << std::endl;
                cin.clear();
                cin.ignore(256,'\n');
                cin >> temp_ID;
            }
          ...
          // Vehicle* sedan1 = new Sedan(30890, 1644,"Toyota", "Toyota Camry Ascent", 7.8 ,5); // Toyota-ID : 1XXX
            ...
            //Adding UTE
                ...
                while(std::cin.fail()) {
                    // to ingnore all the invalid input and ask for a valid input
                ...
                cout << "Please enter a valid body type\n"; // To get rid of the illegal inout of body type
            }
